...
function arrowButtonClick() {
    ...
    if (isLeft) {
        order.indexOf(current_title) === 0 ? current_title = order[order.length - 1] : current_title = order[order.indexOf(current_title) - 1]
    } else {
        order.indexOf(current_title) === order.length - 1 ? current_title = order[0] : current_title = order[order.indexOf(current_title) + 1]
    }
